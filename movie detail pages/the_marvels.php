...
<head>
    ...
    <title>The Marvels | Cinemaplex Booking</title>
</head>
...
<body>
    ...
    <div class="background-image">
        <img src="../images/the-marvels.jpg" alt="">
    </div>

    <div class="content">
        <div class="poster">
            <img src="../images/the-marvels-poster.jpg" alt="poster">
        </div>
        <div class="movie-details">
            <div class="details">
                <h1>The Marvels</h1>
                <p class="genre">Genres : Action, Adventure, Fantasy</p>
                <p class="duration">Duration : 1h 45min</p>
                <a href="https://youtu.be/wS_qbDztgVY?si=TbmLKdH98KcMH6uk" target="_blank"><button class="buy-tickets">Watch Trailer</button></a>
            </div>
            <div class="members">
                <div class="cast">
                    <h2>CAST</h2>
                    <p class="actor">Brie Larson</p>
                    <p class="character">Carol Danvers / Captain Marvel</p>
                    <p class="actor">Samuel L. Jackson</p>
                    <p class="character">Nick Fury</p>
                    <p class="actor">Iman Vellani</p>
                    <p class="character">Kamala Khan / Ms. Marvel</p>
                </div>
                <div class="crew">
                    <h2>CREW</h2>
                    <div>
                        ...
                        <div class="name">
                            <p>Nia DaCosta</p>
                            <p>Victoria Alonso</p>
                            <p>Nia DaCosta , Megan McDonnell</p>
                        </div>
                    </div>
                </div>
            </div>
