...
<head>
    ...
    <title>The Hunger Games | Cinemaplex Booking</title>
</head>
...
<body>
    ...
    <div class="content">
        <div class="poster">
            <img src="../images/the-hunger-games-poster.jpg" alt="poster">
        </div>
        <div class="movie-details">
            <div class="details">
                <h1>The Hunger Games</h1>
                <p class="genre">Genres : Action, Adventure, Drama</p>
                <p class="duration">Duration : 2h 45min</p>
                <a href="https://youtu.be/RDE6Uz73A7g?si=DTTB5JaBfjALTMaE" target="_blank"><button class="buy-tickets">Watch Trailer</button></a>
            </div>
            <div class="members">
                <div class="cast">
                    <h2>CAST</h2>
                    <p class="actor">Rachel Zegler</p>
                    <p class="character">Lucy Gray Baird</p>
                    <p class="actor">Hunter Schafer</p>
                    <p class="character">Tigris Snow</p>
                    <p class="actor">Jason Schwartzman</p>
                    <p class="character">Lucretius 'Lucky' Flickerman</p>
                </div>
                <div class="crew">
                    <h2>CREW</h2>
                    <div>
